 ...
 */
async function reapplyBehaviors() {
...
async function listBehaviors(jsonOutput: boolean = false) {
...
export async function main() {
  ...
  if (command === "list") {
    ...
    await listBehaviors(jsonOutput);
    process.exit(0);
  }
  ...
  console.error(
    ...
    "  list [--json]          List all available behaviors in the registry",
  );
  console.error("");
