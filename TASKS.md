...
- [x] [Refactor `commands` to `command` Throughout Project](docs/tasks/refactor-commands-to-command/task.md)
- [x] [Fix Zod Mini Imports Mismatch in getObservedAttributes](docs/tasks/fix-zod-mini-imports-mismatch/task.md)
