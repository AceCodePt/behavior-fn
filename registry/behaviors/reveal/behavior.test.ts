...
describe('Reveal Behavior', () => {
  const tag = 'div';
  const webcomponentTag = 'test-reveal-div';
  ...
  describe('Focus Restoration', () => {
    ...
    it('should restore focus to the opener when a popover is closed', async () => {
      ...
      const el = document.createElement('div', {
        is: 'test-reveal-div-popover-focus',
      }) as any;

      registerTestComponent(
        'div',
        { tag: 'test-reveal-div-popover-focus' },
        (Base) => class extends Base {},
        { reveal: REVEAL_DEFINITION },
      );
    ...
    it('should restore focus to the opener when a dialog is closed', async () => {
      ...
      const el = document.createElement('dialog', {
        is: 'test-reveal-dialog-focus',
      }) as HTMLDialogElement;

      registerTestComponent(
        'dialog',
        { tag: 'test-reveal-dialog-focus' },
        (Base) => class extends Base {},
        { reveal: REVEAL_DEFINITION },
      );
